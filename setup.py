...
setup(
    ...
    install_requires=[
        ...
        "win32-setctime==1.0.4; sys_platform == 'win32'",
        "xmltodict==0.12.0",
    ...
    extras_require={
        "dev": [
            ...
            "mkdocs-material-extensions==1.0.4; python_version >= '3.6'",
            "orderedmultidict==1.0.4",
            ...
            "pluggy==1.0.4; python_version >= '3.6'",
