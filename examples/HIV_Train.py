...
class Train:
        ...
        try:
            ...
            data = {
                "query_lst": [
                    [
                        "link",
                        "HIVdemo_LMU,HIVdemo_TUM,HIVdemo_UKT",
                        "birthdate",
                        "le1970-01-01",
                    ],
                    [
    ...
    def load_sequences(self, patients, class_labels):
        ...
        _RESIDUE_ENCODING = {
            residue: (index * [0]) + [1] + (len(_RESIDUES) - index - 1) * [0]
            for index, residue in enumerate(_RESIDUES)
        }
        ...
        for index, row in patients.iterrows():
            ...
            if feature_space_dimension is None:
                ...
                raise ValueError(
                    "Inconsistent feature length: {} vs. {}".format(
                        feature_space_dimension, seq_encoded_len
                    )
                )
