...
class Train:
    ...
    def secure_addition_avg(self, total_age, num_pat):
        ...
        try:
            ...
            print(
                "Previous secure addition value total number patients:\n"
        ...
        result["discovery"]["secure_num_pat"] = secure_addition(
            num_pat, prev_num_pat, int(n)
        )
        result["discovery"]["secure_total_age"] = secure_addition(
            total_age, prev_total_age, int(n)
        )
