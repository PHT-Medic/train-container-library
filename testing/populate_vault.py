...
def main():
    ...
    for station in TEST_STATIONS:
        ...
        with open(os.path.join(KEY_DIR, f"station_{station}_private_key.pem"), "wb") as f:
        ...
        loaded_public_key = serialization.load_pem_public_key(bytes.fromhex(public_key_hex))
